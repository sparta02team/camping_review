...
def naver_callback():
    ...
    return render_template('naver_login_callback.html', NAVER_LOGIN_CLIENT_ID=NAVER_LOGIN_CLIENT_ID, NAVER_LOGIN_SERVICE_URL=NAVER_LOGIN_SERVICE_URL, NAVER_LOGIN_CALLBACK_URL=NAVER_LOGIN_CALLBACK_URL)
